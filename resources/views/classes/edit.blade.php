            ...
            <div class="card-body">
                ...
                <form class="row g-3" action="{{ route('classe.update', ['classe' => $classe->id ]) }}" method="POST">
                    ...
                    <div class="col-12">
                      ...
                      <textarea name="description" rows="4" cols="30" id="description" class="form-control" placeholder="Conteúdo da aula" required>{{ old('description', $classe->description) }}</textarea>
                    </div>
